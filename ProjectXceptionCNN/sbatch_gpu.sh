...
##SBATCH --cpus-per-task=2			### number of CPU cores, allocating more than 10G requires IT team's permission
...
python main.py					### this command executes jupyter lab – replace with your own command
